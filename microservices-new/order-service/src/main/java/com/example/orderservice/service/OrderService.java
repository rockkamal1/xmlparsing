...
public class OrderService {
    ...
    public void placeOrder(@RequestBody OrderRequest orderRequest){
       ...
       List<String> skuCodes = order.getOrderLineItemsList().stream().map(orderLineItem ->orderLineItem.getSkuCode()).collect(Collectors.toList());
        ...
        //call inventory service, and placeorder if product is in stock.

      InventoryResponse[] inventoryResponseArray =  webClientBuilder.build().get().uri("http://inventry-service/api/inventory",
